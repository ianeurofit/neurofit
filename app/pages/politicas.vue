...
useSeoMeta({
  title: 'Neurofit IA | Políticas y tratamiento de datos',
  ogTitle: 'Neurofit IA |  Políticas y tratamiento de datos',
  ...
  twitterTitle: 'Neurofit IA |Políticas y tratamiento de datos',
